    ...
    <div class="header-top">
        <div class="container ">
            <div class="top-outer clearfix">
                <!-- Top Left -->
                <ul class="top-left">
                    <li><a href=""><span class="icon flaticon-phone-receiver"></span>Phone: +1 (708) 465-5438</a></li>
                    {{-- <li><span class="icon flaticon-clock-1"></span>Mon-Fri (8am - 6pm)</li> --}}
                    <li><a href="mailto:gracelandbyzyonne@gmail.com"><span class="icon flaticon-letter"></span>gracelandbyzyonne@gmail.com</a></li>
                </ul>
            </div>
        </div>
    </div>
